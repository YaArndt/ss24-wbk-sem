...
state_dict = torch.load(r'Performances\ResNet\Model-Files\ResNet152 - Tv2 - 1.000000e-04.pt', map_location=torch.device('cpu'))
...
test_dataset = datasets.ImageFolder(root='Data/BilderNeu', transform=transform)
