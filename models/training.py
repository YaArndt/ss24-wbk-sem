...
def train_model (
    ...
    for _ in tqdm(range(config.EPOCHS)):
        ...
        for images, labels in test_loader:
            ...
            writer.add_scalar("Test/Accuracy", performance.accuracy(preds, labels), test_i)
            writer.add_scalar("Test/Precision", performance.precision(preds, labels), test_i)
            writer.add_scalar("Test/Recall", performance.recall(preds, labels), test_i)
            writer.add_scalar("Test/F1 Score", performance.f1_score(preds, labels), test_i)
